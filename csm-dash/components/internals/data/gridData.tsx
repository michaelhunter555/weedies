...
function renderStatus(status: "complete" | "pending" | "rejected"| "RFE") {
...
export const columns: GridColDef[] = [
  { field: "pageTitle", headerName: "Action", flex: 1.5, minWidth: 200 },
  {
    field: "status",
    headerName: "Status",
    flex: 0.5,
  ...
  },
  {
    ...
    flex: 1,
    minWidth: 150,
    renderCell: (params) => <Link href={`/case/${params.row._id}`}>
      <Button onClick={() => console.log("hela")}>View details</Button>
    </Link>,
  },
];

/**
 * actionType: dispute | new application 
 * status: complete | rejected | pending | RFE
 * name: string
 * state: string
 * city: string
 * registrationNumber: string;
 * onClick: (id:)
 * imageIdFront: string <- remember to decrypt!
 * imageIdBack: string <- remember to decrypt!
 * 
 */
...
export const rows: GridRowsProp = [
  {
    ...
    status: 'complete',
    userName: 'Michael Hunter',
    state: 'MD',
    city: 'Bowie',
    registrationNumber: 3546432,
    link: '/'
  },
  {
    id: 2,
